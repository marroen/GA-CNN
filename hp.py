...
class HPChromosome:
    ...
    def __init__(self, num_conv = None, num_kernels = None, kernel_size = None, conv_stride = None, num_pooling = None, pool_size = None,
        ...
        self.num_kernels = rng.randint(1,20) if num_kernels is None else 16
        self.kernel_size = rng.randrange(3,5,2) if kernel_size is None else 3
        self.conv_stride = rng.randint(1,2) if conv_stride is None else 1
        ...
        self.num_dense = rng.randint(1,5) if num_dense is None else 4
        self.num_neurons = rng.randint(100, 200) if num_neurons is None else 120
        ...
        self.dropout_rate = rng.uniform(0.2, 0.5) if dropout_rate is None else 0.2
        ...
        self.momentum = rng.uniform(0.5, 0.95) if momentum is None else 0.9
